...
> **How should customer journeys be measured to evaluate the new website?**
...
- Run formal hypothesis tests (e.g., two-proportion z-test) on the completion-rate difference
  between Test and Control, alongside an effect-size measure, following the same
  statistical-significance-vs-practical-significance approach used for the demographic checks.
